...
Another way to notify the user about the ticket's closure, is by having [Feedback](/configuration/ticket-feedback-configuration) enabled
...
Apart from "tags" in the sense of [snippets](/getting-support/using-tags) there is another type of tags: Forum Tags.

The bot automatically manages tags in the ticket forum to help staff filter and organize tickets. The default tags are:
...
These tags are automatically applied to ticket posts based on their status and activity.
